...
export default function Home() {
  ...
  return (
      <div className="min-h-screen bg-background text-foreground font-sans selection:bg-foreground selection:text-background">
        ...
        <nav
            className={cn(
                "fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-6 md:px-12 transition-all duration-500 ease-in-out",
                scrolled
                    ? "bg-background/80 backdrop-blur-md border-b border-border/10 py-4 shadow-sm"
                    : "bg-transparent border-b border-transparent py-8 text-white"
            )}
        >
          <Link href="/">
            <a className="flex items-center gap-3 hover:opacity-70 transition-opacity">
              <img
                  ...
                  className={cn(
                      ...
                      scrolled ? "dark:invert-0 invert" : "invert"
                  )}
              />
              <span className={cn(
          ...
          {/* Desktop Menu */}
          <div className={cn(
              "hidden md:flex items-center gap-8 font-medium text-sm tracking-widest uppercase transition-colors duration-500",
              scrolled ? "text-foreground" : "text-white"
          )}>
        ...
        <section id="contact" className="py-24 md:py-32 px-6 md:px-12 bg-foreground text-background">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-8 text-sm uppercase tracking-widest text-white/60">
              ...
              <p>&copy; {new Date().getFullYear()} Adinsist Creatives. All Rights Reserved.</p>
            </div>
          </div>
        </section>
      </div>
